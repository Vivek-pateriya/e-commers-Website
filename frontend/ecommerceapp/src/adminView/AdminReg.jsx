...
function AdminReg() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:9679/admin/getAdmincount")
      .then((res) => {
  ...
  const handleRegsistration = async () => {
    ...
    axios
      .post("http://localhost:9679/admin/regsiter", obj)
      .then((res) => {
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>Password</td>
            <td>
              <input type="password" value={AUserPass} onChange={handleUserP} />
            </td>
          </tr>
          <tr>
            <td>Full Name</td>
            <td>
              <input type="text" value={AdminName} onChange={handleAdminName} />
            </td>
          </tr>
          <tr>
            <td>Address</td>
